...
<link rel="stylesheet" href="/assets/components/payment_interkassa/css/interkassa.css">

<div class="interkasssa" style="text-align: center;">
    <img style="display: inline-block; width:300px;" src="/assets/components/payment_interkassa/images/logo_interkassa.png"/>
...
{if $interkassa->config['api_enable']}
...
<script type="text/javascript">
    var selpayIK = {
        ...
        req_url: location.pathname + '?paysys',
        selPaysys: function () {
...
{/literal}
<script>selpayIK.actForm = '{$interkassa->actionURL}'</script>